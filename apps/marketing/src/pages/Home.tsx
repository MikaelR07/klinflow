          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
              ...
              <p className={`text-lg font-medium leading-relaxed mb-10 ${isDarkMode ? 'text-slate-400' : 'text-slate-600'}`}>
                Klinflow is more than an app—it is the digital foundation for a circular society. By integrating real-time telemetry, automated rewards, and industrial marketplaces, we are transforming waste into a high-value digital asset.
              </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row items-end justify-between gap-8 mb-20">
            ...
            <p className={`text-base md:text-lg font-medium max-w-sm ${isDarkMode ? 'text-slate-500' : 'text-slate-400'}`}>
              Every transaction in Klinflow is verified by AI and settled instantly, creating a friction-free circular economy.
            </p>
          </div>
