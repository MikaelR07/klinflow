        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
          <div className="max-w-3xl mx-auto mb-20">
            ...
            <p className={`text-base md:text-xl font-medium leading-relaxed ${isDarkMode ? 'text-slate-400' : 'text-slate-600'}`}>
               Stop throwing away value. CleanFlow makes it effortless for residents to schedule pickups, verify their impact, and earn rewards for every kilogram of recyclables recovered.
            </p>
          </div>
