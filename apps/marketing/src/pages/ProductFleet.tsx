    ...
    <Layout>
      ...
      <section className="relative pt-24 md:pt-32 pb-16 md:pb-32 overflow-hidden">
        <div className="absolute inset-0 z-0">
          ...
          />
          <div
            className={`absolute top-0 right-0 w-[600px] h-[600px] bg-indigo-500/10 blur-[120px] rounded-full`}
          />
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 md:gap-24 items-center">
            <div className="order-2 lg:order-1">
              <div className="inline-flex items-center gap-2 text-indigo-500 font-bold uppercase tracking-widest text-xs mb-6">
                <Building2 className="w-4 h-4" /> Platform Three: Fleet &
                Enterprise Admin
              </div>
              <h1
              ...
              >
                Klinflow gives company owners and logistics managers the
                macro-financial tools to track driver performance, inventory
                value, and revenue splits in real-time.
              </p>
            ...
            <div className="order-1 lg:order-2">
              <div className="rounded-2xl overflow-hidden border border-white/5 shadow-2xl relative w-full sm:w-[600px] lg:w-[650px] xl:w-[850px] mx-auto bg-surface-950">
                <img
                  src="/grid/company-owner-homepage.webp"
                  alt="Enterprise Terminal: Fleet Admin"
                  loading="lazy"
            ...
            {[
              {
                ...
                desc: "Klinflow automatically handles the financial split between the agent, the fleet owner, and the platform — settled instantly via M-Pesa.",
                icon: Wallet,
                color: "indigo",
              },
              {
      ...
      >
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-24 items-center">
          <div className="order-2 lg:order-1">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {[
                ...
                <div
                  key={i}
                  className={`p-8 rounded-2xl border transition-all ${isDarkMode ? "bg-white/5 border-white/5 hover:border-indigo-500/20" : "bg-white border-slate-100 hover:border-indigo-500/20 shadow-lg"}`}
                >
          ...
          <div className="order-1 lg:order-2">
            <h2 className="text-sm font-bold uppercase tracking-[0.3em] text-indigo-500 mb-6">
              Strategic Oversight
            </h2>
            <h3
              className={`text-3xl md:text-4xl font-bold tracking-tighter mb-8 ${isDarkMode ? "text-white" : "text-slate-900"}`}
            >
              Total Governance <br className="hidden sm:block" />
              of Circular Assets.
            </h3>
            <p
              className={`text-lg font-medium leading-relaxed mb-12 ${isDarkMode ? "text-slate-400" : "text-slate-600"}`}
            >
              Managing a waste logistics business requires surgical precision.
              Klinflow provides the visibility needed to scale your operations
              from a single truck to a regional fleet with centralized control.
            </p>
      ...
      <section className="py-16 md:py-32 px-6">
        <div
          className={`max-w-7xl mx-auto p-8 md:p-20 rounded-2xl relative overflow-hidden text-center bg-indigo-600`}
        >
          <div
          ...
          <div className="max-w-3xl mx-auto relative z-10 text-white">
            ...
            <p className="text-lg font-medium mb-10 opacity-80 leading-relaxed">
              Connect your existing fleet to the Klinflow network or build a new
              recycling empire from the ground up with our enterprise tools.
            </p>
