          ...
          <div className="grid lg:grid-cols-2 gap-12 md:gap-24 items-center">
            <div className="order-2 lg:order-1">
              ...
              <p className={`text-base md:text-xl font-medium leading-relaxed mb-10 ${isDarkMode ? 'text-slate-400' : 'text-slate-600'}`}>
                Klinflow gives company owners and logistics managers the macro-financial tools to track driver performance, inventory value, and revenue splits in real-time.
              </p>
            ...
            <div className="order-1 lg:order-2">
              <div className="rounded-2xl overflow-hidden border border-white/5 shadow-2xl relative bg-slate-900">
                <img src="/grid/agent-home.webp" alt="Enterprise Terminal: Fleet Admin" loading="lazy" className="w-full h-auto" />
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-24 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className={`text-lg font-medium leading-relaxed mb-12 ${isDarkMode ? 'text-slate-400' : 'text-slate-600'}`}>
              Managing a waste logistics business requires surgical precision. Klinflow provides the visibility needed to scale your operations from a single truck to a regional fleet with centralized control.
            </p>
        ...
        <div className={`max-w-7xl mx-auto p-8 md:p-20 rounded-2xl relative overflow-hidden text-center bg-indigo-600`}>
           ...
           <div className="max-w-3xl mx-auto relative z-10 text-white">
              ...
              <p className="text-lg font-medium mb-10 opacity-80 leading-relaxed">
                Connect your existing fleet to the Klinflow network or build a new recycling empire from the ground up with our enterprise tools.
              </p>
