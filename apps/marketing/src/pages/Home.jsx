...
const appCards = [
  { 
    ...
    img: '/placeholder-images/grid-images/seller-home.png',
  ...
  { 
    ...
    img: '/placeholder-images/grid-images/agent-home.png',
    path: '/products/agent',
    icon: Truck,
    color: 'blue'
  },
  { 
    ...
    img: '/placeholder-images/grid-images/business-home.png',
    path: '/products/fleet',
    icon: Building2,
    color: 'indigo'
  },
  { 
    ...
    img: '/placeholder-images/grid-images/Hub-home.png',
    path: '/products/hub',
    icon: Warehouse,
    color: 'rose'
  }
...
export default function Home() {
  ...
  const screenshots = [
    { src: '/placeholder-images/grid-images/agent-home.png', alt: 'Agent Terminal - Tactical Mission Control' },
    { src: '/placeholder-images/grid-images/seller-home.png', alt: 'Merchant Dashboard - Marketplace Trade Hub' },
    { src: '/placeholder-images/grid-images/book-pickup.png', alt: 'Resident Terminal - Mission Request Interface' },
    { src: '/placeholder-images/grid-images/business-home.png', alt: 'B2B Business Portal - Bulk Material Sourcing' },
    { src: '/placeholder-images/grid-images/Resident-home.png', alt: 'Resident Dashboard - Household Waste Management' },
    { src: '/placeholder-images/grid-images/Hub-home.png', alt: 'Hub Command Center - Industrial Intake' },
    { src: '/placeholder-images/grid-images/admin-dashboard.png', alt: 'System Administration - Global Network Stats' },
    { src: '/placeholder-images/grid-images/company-owner-home.png', alt: 'Fleet Admin - Logistics Company Management' },
    { src: '/placeholder-images/grid-images/agent-dashboard.png', alt: 'Agent Analytics - Performance & Earnings Tracking' },
  ];
