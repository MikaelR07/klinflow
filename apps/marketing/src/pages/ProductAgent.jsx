    ...
    <Layout>
          ...
          <div className="grid lg:grid-cols-2 gap-12 md:gap-24 items-center">
            <div className="order-2 lg:order-1">
              ...
              <h1 className={`text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-bold tracking-tighter mb-8 ${isDarkMode ? 'text-white' : 'text-slate-900'}`}>
                ...
                As A <span className="text-blue-500 italic">Collection Pro.</span>
              </h1>
              <p className={`text-base md:text-xl font-medium leading-relaxed mb-10 ${isDarkMode ? 'text-slate-400' : 'text-slate-600'}`}>
                CleanFlow provides independent agents and fleet drivers with the tactical tools to find, verify, and monetize circular assets with surgical precision.
              </p>
            ...
            <div className="order-1 lg:order-2">
              <div className="rounded-2xl overflow-hidden border border-white/5 shadow-2xl relative bg-slate-900">
                <img src="/placeholder-images/grid-images/agent-home.webp" alt="Agent Terminal: Mission Control" loading="lazy" className="w-full h-auto" />
              ...
              <motion.div 
                ...
                className="absolute -top-10 -right-10 p-6 rounded-2xl bg-white dark:bg-slate-900 shadow-2xl border border-slate-100 dark:border-white/5 max-w-[260px] hidden sm:block"
              >
      ...
      <section className={`py-16 md:py-32 px-6 ${isDarkMode ? 'bg-slate-950' : 'bg-slate-50'}`}>
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-24 items-center">
            ...
            <div className="p-12 rounded-2xl bg-slate-900 border border-white/5 shadow-2xl relative overflow-hidden">
               ...
               <div className="relative z-10 space-y-12">
                  ...
                  <div className="space-y-4">
                     <p className="text-xs font-bold text-slate-500 uppercase tracking-widest">Today's Fleet Activity</p>
                     <div className="flex gap-2">
                        {[40, 70, 45, 90, 65, 80, 55].map((h, i) => (
                           <div key={i} className="flex-1 h-12 bg-white/5 rounded-lg overflow-hidden flex flex-col justify-end">
                              <motion.div 
                                 initial={{ height: 0 }}
          ...
          <div className="order-1 lg:order-2">
            <h2 className="text-sm font-bold uppercase tracking-[0.3em] text-blue-500 mb-6">Tactical Excellence</h2>
            <h3 className={`text-2xl sm:text-3xl md:text-5xl font-bold tracking-tighter mb-8 ${isDarkMode ? 'text-white' : 'text-slate-900'}`}>The HUD for High-Yield Logistics.</h3>
            <p className={`text-lg font-medium leading-relaxed mb-12 ${isDarkMode ? 'text-slate-400' : 'text-slate-600'}`}>
              Agents are the backbone of the circular economy. We equip you with high-precision tracking, AI verification, and financial tools to turn your logistics work into a professional, profitable career.
            </p>
      ...
      <section className="py-16 md:py-32 px-6">
        <div className={`max-w-7xl mx-auto p-8 md:p-20 rounded-2xl relative overflow-hidden text-center bg-blue-600`}>
           <div className="absolute inset-0 opacity-10" style={{ backgroundImage: 'radial-gradient(circle, white 1px, transparent 1px)', backgroundSize: '30px 30px' }} />
           <div className="max-w-2xl mx-auto relative z-10 text-white">
              <h2 className="text-2xl sm:text-4xl md:text-6xl font-bold tracking-tighter mb-8">Ready to Join the Fleet?</h2>
              <p className="text-lg font-medium mb-10 opacity-80 leading-relaxed">
                Whether you are an individual collector or a company owner, CleanFlow gives you the platform to scale your collection operations.
              </p>
