          ...
          <div className="grid lg:grid-cols-2 gap-12 md:gap-24 items-center">
            <div className="order-2 lg:order-1">
              ...
              <p className={`text-base md:text-xl font-medium leading-relaxed mb-10 ${isDarkMode ? 'text-slate-400' : 'text-slate-600'}`}>
                Whether you are a household resident or a professional bulk seller, CleanFlow provides the valuation tools and logistics network to monetize your recyclables.
              </p>
            ...
            <div className="order-1 lg:order-2">
              <div className="rounded-2xl overflow-hidden border border-white/5 shadow-2xl relative">
                <img src="/placeholder-images/grid-images/seller-home.webp" alt="Client Terminal: Seller Home" loading="lazy" className="w-full h-auto" />
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-24 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className={`text-lg font-medium leading-relaxed mb-12 ${isDarkMode ? 'text-slate-400' : 'text-slate-600'}`}>
              The CleanFlow Client app provides absolute transparency. From the moment you post a pickup to the final industrial sale, you can track the status, grade, and financial valuation of your circular assets.
            </p>
