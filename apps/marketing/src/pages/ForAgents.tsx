    ...
    <Layout>
      <section className="relative pt-24 md:pt-32 pb-16 md:pb-32 overflow-hidden">
        <div className="absolute inset-0 z-0">
          ...
          <div className={`absolute top-0 right-0 w-[500px] h-[500px] bg-blue-500/10 blur-[120px] opacity-30 rounded-full`} />
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
          <div className="max-w-3xl mx-auto mb-20">
            ...
            <p className={`text-base md:text-xl font-medium leading-relaxed ${isDarkMode ? 'text-slate-400' : 'text-slate-600'}`}>
               Klinflow provides individual collectors and fleet drivers with guaranteed job flow, AI-optimized routing, and instant payouts. Build your career in circular logistics.
            </p>
          </div>
      ...
      <section className="py-16 md:py-32 px-6">
         <div className={`max-w-5xl mx-auto p-8 md:p-20 rounded-2xl text-center bg-blue-600`}>
            <h2 className="text-3xl md:text-4xl font-bold tracking-tighter mb-8 text-white">Join the Fleet.</h2>
