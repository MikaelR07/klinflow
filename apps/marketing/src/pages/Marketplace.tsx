          ...
          <div className="grid lg:grid-cols-2 gap-12 md:gap-24 items-center">
            <div className="order-2 lg:order-1">
              ...
              <p className={`text-base md:text-xl font-medium leading-relaxed mb-10 ${isDarkMode ? 'text-slate-400' : 'text-slate-600'}`}>
                Klinflow's B2B marketplace connects verified supply with industrial demand. We eliminate friction in circular trading through automated escrow, AI grading, and real-time logistics.
              </p>
            ...
            {[
              {
                ...
                desc: 'Informal collectors browse and claim verified material lots from the Klinflow network. Smart matching recommends assets based on location and material specialization.',
                icon: Package,
                color: 'teal'
              },
              {
           ...
           <div className="grid md:grid-cols-3 gap-8">
              {[
                 ...
                 },
                 {
                    ...
                    desc: 'Manage your full inventory — both Klinflow-sourced and independently collected — in a unified dashboard with AI valuation.',
                    icon: Layers
                 },
                 {
