          ...
          <div className="grid lg:grid-cols-2 gap-12 md:gap-24 items-center">
            <div className="order-2 lg:order-1">
              ...
              <p className={`text-base md:text-xl font-medium leading-relaxed mb-10 ${isDarkMode ? 'text-slate-400' : 'text-slate-600'}`}>
                Klinflow provides independent agents and fleet drivers with the tactical tools to find, verify, and monetize circular assets with surgical precision.
              </p>
            ...
            <div className="order-1 lg:order-2">
              <div className="rounded-2xl overflow-hidden border border-white/5 shadow-2xl relative bg-slate-900">
                <img src="/grid/agent-home.webp" alt="Agent Terminal: Mission Control" loading="lazy" className="w-full h-auto" />
        ...
        <div className={`max-w-7xl mx-auto p-8 md:p-20 rounded-2xl relative overflow-hidden text-center bg-blue-600`}>
           ...
           <div className="max-w-2xl mx-auto relative z-10 text-white">
              ...
              <p className="text-lg font-medium mb-10 opacity-80 leading-relaxed">
                Whether you are an individual collector or a company owner, Klinflow gives you the platform to scale your collection operations.
              </p>
