    ...
    <Layout>
      ...
      <section className="relative pt-24 md:pt-32 pb-16 md:pb-32 overflow-hidden">
        <div className="absolute inset-0 z-0">
          ...
          />
          <div
            className={`absolute top-0 right-0 w-[600px] h-[600px] bg-primary/10 blur-[120px] rounded-full`}
          />
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 md:gap-24 items-center">
            <div className="order-2 lg:order-1">
              <div className="inline-flex items-center gap-2 text-primary font-bold uppercase tracking-widest text-xs mb-6">
                <User className="w-4 h-4" /> Platform One: Resident & Seller
                Portal
              </div>
              <h1
              ...
              >
                ...
                Into{" "}
                <span className="text-primary italic">Instant Wealth.</span>
              </h1>
              <p
                className={`text-base md:text-xl font-medium leading-relaxed mb-10 ${isDarkMode ? "text-slate-400" : "text-slate-600"}`}
              >
                Whether you are a household resident or a professional bulk
                seller, Klinflow provides the valuation tools and logistics
                network to monetize your recyclables.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                <button className="px-8 py-4 bg-primary text-white font-bold rounded-2xl shadow-xl shadow-emerald-500/20 active:scale-95 transition-all">
                  Download Mobile App
                </button>
                <button
            ...
            <div className="order-1 lg:order-2">
              <div className="rounded-2xl overflow-hidden border border-white/5 shadow-2xl relative w-full max-h-[520px] object-contain mx-auto">
                <img
                  src="/grid/seller-home.webp"
                  alt="Client Terminal: Seller Home"
                  loading="lazy"
              ...
              <motion.div
                ...
                className="absolute -top-14 -right-28 p-6 rounded-2xl bg-white dark:bg-surface-800 shadow-2xl border border-slate-100 dark:border-white/5 max-w-[240px] hidden sm:block"
              >
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    ...
                    <p className="text-lg font-bold text-primary">KSh 4,250</p>
                  </div>
                </div>

                <p className="text-xs text-slate-400 font-medium">
                  Payout triggered for 45kg HDPE Grade A collection.
                </p>
              </motion.div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-24 items-center">
          <div className="order-2 lg:order-1">
            <div className="relative aspect-[4/3] rounded-2xl overflow-hidden border border-white/5 shadow-2xl">
              <div className="absolute inset-0 bg-surface-950 flex items-center justify-center p-12">
                  ...
                  {[
                    ...
                    >
                      <div className="flex items-center gap-4">
                        <div
                          className={`w-3 h-3 rounded-full bg-${item.color}-500 ${item.status === "In Progress" ? "animate-pulse" : ""}`}
                        />
          ...
          <div className="order-1 lg:order-2">
            ...
            >
              Track Every Gram <br className="hidden sm:block" />
              to the Payout.
            </h3>
            <p
              className={`text-lg font-medium leading-relaxed mb-12 ${isDarkMode ? "text-slate-400" : "text-slate-600"}`}
            >
              The Klinflow Client app provides absolute transparency. From the
              moment you post a pickup to the final industrial sale, you can
              track the status, grade, and financial valuation of your circular
              assets.
            </p>
      ...
      <section className="py-16 md:py-32 px-6">
        <div
          className={`max-w-7xl mx-auto p-8 md:p-20 rounded-2xl relative overflow-hidden text-center ${isDarkMode ? "bg-surface-950" : "bg-slate-50"}`}
        >
          <div className="max-w-2xl mx-auto relative z-10">
            <h2
              className={`text-3xl md:text-4xl font-bold tracking-tighter mb-8 ${isDarkMode ? "text-white" : "text-slate-900"}`}
            >
              Start Monetizing Your Waste Today.
            </h2>
            <p className="text-lg text-slate-500 font-medium mb-10 leading-relaxed">
              Join 50,000+ residents and sellers who are turning sustainability
              into a high-yield reality.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <button className="w-full sm:w-auto px-10 py-5 bg-primary text-white font-bold rounded-2xl shadow-xl shadow-emerald-500/20 active:scale-95 transition-all">
                Get Started for Free
              </button>
              <button className="w-full sm:w-auto px-10 py-5 border rounded-2xl font-bold transition-all border-primary/20 text-primary hover:bg-primary/5">
                View App Features
              </button>
            </div>
          </div>
