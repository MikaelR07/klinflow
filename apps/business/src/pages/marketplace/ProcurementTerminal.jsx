      ...
      <div className="space-y-6 mt-2 pb-24">
        ...
        <div className="grid grid-cols-3 gap-2 px-4">
          <div className="bg-blue-600 rounded-[0.45rem] p-3 text-white shadow-xl shadow-blue-600/20 relative overflow-hidden">
            ...
            <h3 className="text-xl font-black leading-none">1.2k<span className="text-[8px] ml-0.5 opacity-60 font-medium">T</span></h3>
          </div>
        ...
        <div className="flex bg-slate-200/50 dark:bg-slate-800 p-1 rounded-[0.45rem] mx-4">
          <button 
            ...
            className={`flex-1 py-2 rounded-[0.4rem] text-[10px] font-bold uppercase tracking-widest transition-all ${activeTab === 'open' ? 'bg-white dark:bg-slate-900 text-blue-600 shadow-sm' : 'text-slate-500'}`}
          >
            Global Requests
          </button>
          <button 
            onClick={() => setActiveTab('my-requests')}
            className={`flex-1 py-2 rounded-[0.4rem] text-[10px] font-bold uppercase tracking-widest transition-all ${activeTab === 'my-requests' ? 'bg-white dark:bg-slate-900 text-blue-600 shadow-sm' : 'text-slate-500'}`}
          >
            My Sourcing
          </button>
        </div>
            ...
            >
              ...
              <div className="flex items-start justify-between mb-5">
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    <span className="text-[10px] font-bold text-slate-500">{rfq.buyer}</span>
                    <div className="w-1 h-1 rounded-full bg-slate-300 dark:bg-slate-600" />
                    <span className="text-[10px] font-bold text-slate-400">{rfq.location}</span>
                    {rfq.isVerified && (
                ...
                <div className="text-right">
                  <p className="text-[8px] font-bold text-slate-400 uppercase tracking-widest mb-1">Target Price</p>
              ...
              <div className="grid grid-cols-3 gap-3 pt-5 border-t border-slate-50 dark:border-slate-700/50">
                <div className="text-center">
                  <p className="text-[8px] font-bold text-slate-400 uppercase tracking-widest mb-1">Volume</p>
                ...
                <div className="text-center border-x border-slate-50 dark:border-slate-700/50">
                  <p className="text-[8px] font-bold text-slate-400 uppercase tracking-widest mb-1">Quotes</p>
                  <div className="flex items-center justify-center gap-1 text-slate-700 dark:text-slate-300">
                ...
                <div className="text-center">
                  <div className="w-full h-full text-blue-600 text-[10px] font-black uppercase tracking-widest flex items-center justify-center gap-1">
