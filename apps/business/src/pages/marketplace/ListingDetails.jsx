...
import { useAuthStore, useMarketplaceStore } from '@cleanflow/core';
...
export default function ListingDetails() {
  ...
  if (loading) return (
    <div className="min-h-screen bg-[#F4F4F4] dark:bg-slate-900 flex flex-col items-center justify-center p-6 text-center">
      ...
      <p className="text-xs font-bold text-slate-400 uppercase tracking-widest">Loading Listing...</p>
    </div>
  );
  ...
  if (error || !item) return (
    <div className="min-h-screen bg-[#F4F4F4] dark:bg-slate-900 flex flex-col items-center justify-center p-8 text-center animate-fade-in">
      ...
      <p className="text-xs text-slate-400 mb-8 max-w-[260px]">This listing may have been removed or is no longer available.</p>
  ...
  return (
    <div className="min-h-screen bg-[#F4F4F4] dark:bg-slate-900 pb-32">
      <div className="animate-fade-in -mx-2 -mt-5">
        ...
        {/* Content Sheet */}
        <div className="relative -mt-8 bg-[#F4F4F4] dark:bg-slate-900 rounded-t-3xl px-6 pt-8 pb-12 space-y-6 shadow-[0_-10px_40px_rgba(0,0,0,0.05)] dark:shadow-none min-h-[60vh]">
          ...
          {!isOwnListing && (
            <div className="space-y-3 pt-4">
              ...
              <button 
                ...
                className="w-full py-4 bg-white dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 rounded-2xl font-bold text-xs uppercase tracking-widest text-slate-700 dark:text-white flex items-center justify-center gap-2 active:scale-[0.98] transition-all"
              >
