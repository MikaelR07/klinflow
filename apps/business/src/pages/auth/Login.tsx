...
import { Store, Lock, Phone, Loader2, ArrowRight, Eye, EyeOff } from 'lucide-react';
              ...
              <div>
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-12 py-4 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-2xl text-slate-900 dark:text-white font-medium focus:ring-4 text-base focus:ring-indigo-500/10 focus:border-indigo-500 transition-all outline-none"
                    required
                  />
                  <button
                    type="button"
