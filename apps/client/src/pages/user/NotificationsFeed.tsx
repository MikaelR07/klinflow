        ...
        <div className="flex items-center justify-between px-4 h-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="text-[11px] font-bold capitalize tracking-widest text-slate-600 dark:text-slate-300 bg-slate-100 dark:bg-slate-900  px-3.5 py-1.5 rounded-lg transition-colors"
            >
              Settings
            </button>
          </div>
