                        ...
                        <div className="space-y-2.5">
                          ...
                          <div className="relative group">
                            <input
                              ...
                              className="w-full bg-slate-100 dark:bg-slate-800 p-4 pl-11 pr-10 rounded-2xl border border-slate-100 dark:border-slate-800 text-xs font-semibold dark:text-white outline-none focus:border-primary/50 focus:ring-2 ring-primary/20 transition-all shadow-sm"
                            />
