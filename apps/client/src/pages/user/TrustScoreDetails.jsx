          ...
          <div className="relative z-10 flex items-center justify-between mb-8">
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-2">
                ...
                <p className="text-[10px] font-semibold uppercase tracking-widest text-slate-500 dark:text-slate-400">Lifetime Earnings</p>
              </div>
            ...
            <div className="flex-1 text-right">
              <div className="flex items-center justify-end gap-2 mb-2">
                ...
                <p className="text-[10px] font-semibold uppercase tracking-widest text-slate-500 dark:text-slate-400">Total Weight Traded</p>
              </div>
          ...
          <div className="relative z-10 mt-4 pt-4 border-t border-slate-100 dark:border-slate-700/50">
             ...
             <div className="flex items-center gap-6 w-full">
                ...
                <div className="flex-1 space-y-4">
                   ...
                   <button className="w-full py-3.5 bg-emerald-500 hover:bg-emerald-400 text-white text-[10px] font-semibold uppercase tracking-widest rounded-2xl transition-all shadow-lg shadow-emerald-500/20 active:scale-95 whitespace-nowrap">
                     Apply Loan
                   </button>
                </div>
             </div>
                ...
                <div key={i} className="bg-white dark:bg-slate-900 p-5 rounded-2xl border border-slate-100 dark:border-slate-800 flex items-center gap-4 group">
                   ...
                   <div className="flex-1">
                      <div className="flex items-center justify-between">
                         ...
                         <span className={`text-[8px] font-semibold uppercase tracking-widest px-2 py-0.5 rounded-lg ${m.status === 'Completed' ? 'bg-emerald-500 text-white' : 'bg-slate-100 dark:bg-slate-800 text-slate-400'}`}>
                           {m.status}
                         </span>
                      </div>
                      <p className="text-[10px] font-medium text-slate-400 mt-1 leading-relaxed">{m.desc}</p>
                   </div>
                </div>
              ))}
           </div>
