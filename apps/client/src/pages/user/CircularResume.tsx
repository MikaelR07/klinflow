...
export default function CircularResume() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#F0F2F5] dark:bg-slate-800 transition-colors">
      {/* ── FIXED TOP NAV ── */}
      ...
      <main className="flex-1 px-1.5 pt-[calc(env(safe-area-inset-top,1rem)+3.75rem)] pb-24 max-w-lg mx-auto w-full space-y-4">
        ...
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-1 gap-2">
            <div className="bg-white dark:bg-slate-800 p-4 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-sm flex items-center justify-between">
              <div className="flex items-center gap-3">
        ...
        <div
          ...
          className="bg-gradient-to-br from-indigo-600 to-indigo-800 rounded-2xl p-5 text-white  relative overflow-hidden group active:scale-[0.98] transition-all cursor-pointer"
        >
        ...
        {/* ── ASSET BREAKDOWN ── */}
        <div className="bg-white dark:bg-slate-800 rounded-2xl p-5 border border-slate-100 dark:border-slate-800 shadow-sm space-y-3">
