              ...
              <div className="bg-[#F2F3F4] dark:bg-slate-800 px-2 pt-4 pb-2 space-y-4 rounded-t-xl -mt-16 relative z-10 shadow-[0_-20px_40px_rgba(0,0,0,0.05)]">
                ...
                <div className="space-y-2">
                  {selectedListing.status === 'active' ? (
                    ...
                    <div className={`p-4 rounded-2xl border-2 flex items-center justify-center gap-3 text-xs font-black capitalize tracking-[0.2em] ${selectedListing.status === 'sold'
