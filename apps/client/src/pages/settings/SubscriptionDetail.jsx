...
export default function SubscriptionDetail() {
  ...
  const isCurrent = (profile?.subscription_tier === tierId || profile?.subscriptionTier === tierId);
  ...
  const expandedDetails = {
    lite: {
      ...
      longDesc: "The Basic plan is perfect for occasional recyclers who want access to the CleanFlow marketplace without a monthly commitment. You pay a small platform fee per booking to help us keep the network running.",
      points: [
    ...
    standard: {
      ...
      longDesc: "CleanFlow Plus is our most popular plan. By removing the platform fee, it practically pays for itself if you book more than twice a month. Plus, you get official Impact Certificates to track your environmental contribution.",
      points: [
    ...
    premium: {
      ...
      longDesc: "CleanFlow Elite is designed for those who want to lead the change. Not only do you get the highest reward multipliers, but you also get property management and our exclusive Verified Payment Protection.",
      points: [
