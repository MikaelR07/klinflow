      ...
      <div className="max-w-md w-full mx-auto relative z-10 animate-fade-in">
        ...
        <div className="flex flex-col items-center mb-10">
          <div className="w-full flex items-center justify-between mb-6">
            <Link to="/login" className="flex items-center gap-2 text-xs font-semibold capitalize tracking-widest text-slate-400 hover:text-primary transition-colors">
        ...
        <form onSubmit={initiateRegistration} className="space-y-6">
          ...
          <div className="glass p-6 rounded-[2rem] border border-slate-200 dark:border-slate-800 shadow-xl shadow-slate-200/40 dark:shadow-none space-y-5">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h3 className="text-xs font-semibold text-slate-400 capitalize tracking-widest">Personal Identification</h3>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              {[
                ...
                >
                  ...
                  <span className={`text-[11px] font-semibold capitalize tracking-widest ${formData.gender === g.id ? 'text-primary' : 'text-slate-400'}`}>
                    {g.label}
                  </span>
                </button>
              ))}
          ...
          <div className="glass p-6 rounded-[2rem] border border-slate-200 dark:border-slate-800 shadow-xl shadow-slate-200/40 dark:shadow-none space-y-5">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h3 className="text-xs font-semibold text-slate-400 capitalize tracking-widest">Security Vault</h3>
            </div>
          ...
          <div className="max-w-sm w-full bg-white dark:bg-slate-800 rounded-[2.5rem] p-8 shadow-2xl border border-slate-200 dark:border-slate-800 relative animate-in zoom-in slide-in-from-bottom-8 duration-500 ease-out">
            ...
            <div className="text-center space-y-6">
              ...
              <button
                ...
                className="w-full py-5 bg-primary text-white rounded-[1.5rem] font-semibold text-[13px] capitalize tracking-[0.2em] shadow-xl shadow-primary/20 hover:scale-[1.02] active:scale-95 transition-all flex justify-center items-center gap-2"
              >
