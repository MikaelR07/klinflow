import { Zap, TrendingUp, Target, Bell, MapPin, Award, Clock, Users, ArrowRight } from 'lucide-react';
...
export default function MarketPulseTipsTab({ marketData }: MarketPulseTipsTabProps) {
  return (
    <motion.div
      key="tips-view"
