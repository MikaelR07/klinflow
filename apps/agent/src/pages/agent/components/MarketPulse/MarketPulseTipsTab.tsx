...
import { MarketData } from '../../types/marketPulse.types';

interface MarketPulseTipsTabProps {
  marketData: MarketData;
}

export default function MarketPulseTipsTab({
  marketData,
}: MarketPulseTipsTabProps) {
  return (
    <motion.div
      key="tips-view"
    ...
    >
      {/* Hero Section */}
      <div className="bg-gradient-to-br from-emerald-700 to-emerald-900 dark:bg-[#0A101D] rounded-xl p-4 relative overflow-hidden shadow-sm dark:shadow-none">
      ...
      {/* Community Section */}
      <div className="bg-white dark:bg-[#0A101D] rounded-xl border border-slate-200 dark:border-slate-800/60 overflow-hidden shadow-sm dark:shadow-none">
        <div className="p-4">
          <div className="flex items-start gap-3">
