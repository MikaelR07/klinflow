import { GitGraph, TrendingUp, Zap, MapPin, BrainCircuit, BrainCog, Brain } from 'lucide-react';
import { motion } from 'framer-motion';
import { MarketData } from '../../types/marketPulse.types';

interface MarketPulseTrendsTabProps {
  marketData: MarketData;
}

export default function MarketPulseTrendsTab({ marketData }: MarketPulseTrendsTabProps) {
  return (
    <motion.div
      key="trends-view"
    ...
    >
      ...
      <div className="space-y-2">
        <div className="flex items-center justify-between px-1">
          <h3 className="text-sm font-bold text-slate-400 tracking-tight">Top Opportunities Today</h3>
        </div>
