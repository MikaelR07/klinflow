        ...
        <div className="flex-1 relative">
          ...
          <div className="absolute right-4 top-1/2 -translate-y-1/2 z-[1000] flex flex-col gap-3">
            ...
            <button
              ...
              className={`w-12 h-12 bg-white dark:bg-emerald-950/40 rounded-2xl shadow-xl flex items-center justify-center active:scale-90 transition-all border  dark:border-slate-900 dark:border-emerald-500/20 group relative`}
            >
            ...
            <button onClick={calculateRoute} className={`w-12 h-12 bg-white dark:bg-slate-800 rounded-2xl shadow-xl flex items-center justify-center active:scale-90 transition-all border border-slate-200 dark:border-slate-800 ${isOptimizing ? 'animate-spin' : ''}`}>
      ...
      <AnimatePresence>
        {isDrawerOpen && (
          <motion.div
            ...
            animate={{ y: 0 }}
            exit={{ y: '100%' }}
            className="fixed inset-0 z-[2000] bg-white dark:bg-slate-800 pt-10"
          >
