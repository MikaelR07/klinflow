...
export default function RoleSelection() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900 flex flex-col p-4 relative overflow-hidden">
      {/* Background Decor */}
      ...
      <div className="flex-1 space-y-3 relative z-10">
        {roles.map((role, idx) => (
          ...
          >
            ...
            <div className="relative bg-[#FFFFFF] dark:bg-slate-900 border-2 border-slate-300 dark:border-slate-700 rounded-[2rem] p-5 transition-all md:group-hover:border-emerald-500/30 md:group-hover:-translate-y-1">
