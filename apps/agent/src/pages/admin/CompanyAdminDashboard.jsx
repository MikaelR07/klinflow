      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        ...
        <div className="bg-slate-900 text-white p-4 px-6 rounded-[2rem] flex items-center gap-6 shadow-2xl shadow-slate-900/20 border border-white/5">
          <div className="flex items-center gap-3">
             ...
             <div>
                <p className="text-[9px] font-semibold uppercase tracking-[0.2em] text-emerald-400 leading-none mb-1">Marketplace Visibility</p>
        ...
        <div className="relative group perspective-1000 md:col-span-2">
          ...
          <div className="relative bg-gradient-to-br from-emerald-800 to-emerald-600 rounded-[2rem] p-6 shadow-xl shadow-emerald-900/30 overflow-hidden h-full flex flex-col justify-between">
            ...
            <div className="grid grid-cols-3 gap-4 pt-4 border-t border-white/10 relative z-10">
              <div>
                <p className="text-[10px] font-semibold text-emerald-300 uppercase tracking-widest mb-1">Fleet Today</p>
                <p className="text-2xl font-semibold text-white leading-none">{earnings.completedToday || 0}</p>
              </div>
              <div>
                <p className="text-[10px] font-semibold text-emerald-300 uppercase tracking-widest mb-1">Fleet Total</p>
                <p className="text-2xl font-semibold text-white leading-none">{earnings.totalJobs || 0}</p>
              </div>
              <div>
                <p className="text-[10px] font-semibold text-amber-300 uppercase tracking-widest mb-1">Fleet Rating</p>
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center gap-4">
             ...
             <button 
               ...
               className="flex items-center gap-2 px-4 py-2 bg-slate-100 dark:bg-slate-700/50 hover:bg-primary hover:text-white rounded-xl text-[10px] font-semibold uppercase tracking-widest transition-all group"
             >
               <Users className="w-3.5 h-3.5" />
               <span className="hidden sm:inline">Roster</span>
             </button>
             <span className="px-3 py-1 bg-emerald-50 dark:bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 text-[10px] font-semibold uppercase tracking-widest rounded-full border border-emerald-200 dark:border-emerald-900">
            ...
            {fleetDrivers.filter(d => d.is_online).map((driver) => (
              <div key={driver.id} className="p-4 bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-2xl flex items-center gap-4 hover:border-emerald-200 transition-colors group shadow-sm">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-[10px] font-semibold text-slate-500 uppercase tracking-widest flex items-center gap-1 mt-0.5">
