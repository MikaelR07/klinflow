    ...
    <div className=" bg-[#F8F8FF] dark:bg-slate-800 transition-colors">
      ...
      <div className="w-full pt-[calc(env(safe-area-inset-top,1rem)+5.5rem)] pb-24 px-1.5 space-y-6 max-w-lg mx-auto">
        ...
        <div className="grid grid-cols-2 gap-3">
           <a href="tel:+254123456789" className="p-5 rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-800 hover:border-primary transition-all flex flex-col items-center justify-center gap-3 text-center shadow-sm">
           ...
           <a href="https://wa.me/254123456789" target="_blank" rel="noreferrer" className="p-5 rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-800 hover:border-[#25D366] transition-all flex flex-col items-center justify-center gap-3 text-center shadow-sm">
