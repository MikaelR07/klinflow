...
export default function ProfilePage() {
  ...
  return (
    <div className=" bg-[#F8F8FF] dark:bg-slate-800 transition-colors">
      ...
      <div className={`w-full ${isCompanyAdmin ? 'pt-8' : 'pt-[calc(env(safe-area-inset-top,1rem)+4rem)]'} pb-5 px-1.5 space-y-6 max-w-lg mx-auto`}>

        {/* Avatar Section */}
        <div className="flex flex-col items-center mb-8">
          <div className="relative group">
            <div className="w-24 h-24 rounded-full border-4 border-white dark:border-slate-800 overflow-hidden bg-slate-100 dark:bg-slate-900 flex items-center justify-center text-4xl">
              {profile?.avatarUrl ? (
