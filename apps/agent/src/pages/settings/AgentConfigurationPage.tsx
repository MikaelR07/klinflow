    ...
    <div className="animate-slide-up pb-24 px-1">
      ...
      {!isCompanyAdmin && (
        <div className="fixed top-0 left-0 right-0 z-50 max-w-lg mx-auto bg-white/90 dark:bg-slate-800/90 backdrop-blur-xl border-b border-slate-200 dark:border-slate-800 transition-all duration-300">
          <div className="pt-[calc(env(safe-area-inset-top,1.5rem)+0.75rem)] pb-4 px-4 flex items-center justify-between">
      ...
      <div className={`${isCompanyAdmin ? 'pt-4' : 'pt-[calc(env(safe-area-inset-top,1.5rem)+6rem)]'} px-4`}>
                  ...
                  return (
                    <div key={slug} className="space-y-2">
                      <div className="flex flex-col bg-slate-50 dark:bg-slate-800 rounded-[1rem] border border-slate-100 dark:border-slate-700 overflow-hidden">
                        <div className="flex items-center justify-between p-4">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <input
                              ...
                              className="w-16 p-2 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-center font-semibold text-primary outline-none"
                            />
                        ...
                        {isExpanded && (
                          <div className="p-4 bg-white dark:bg-slate-800 border-t border-slate-200 dark:border-white/5 space-y-4 animate-slide-down">
