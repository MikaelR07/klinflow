...
export default function CompanyMetrics() {
  ...
  // ── Derived Analytics (Global from Store for consistency) ──
  const totalWeight = stats?.totalWeight || 0;
  const totalRevenue = stats?.commissionRevenue || 0;
        ...
        <div className="relative z-10 flex flex-col md:flex-row justify-between gap-8">
          <div>
            ...
            <p className="text-slate-400 text-sm mt-2 max-w-md">
              Live operational intelligence for all corporate tenants and their fleets on the Klinflow network.
            </p>
          </div>
