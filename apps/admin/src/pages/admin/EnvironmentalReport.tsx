      ...
      <div ref={reportRef} className="bg-white dark:bg-slate-900 p-12 rounded-[3rem] border border-slate-100 dark:border-white/5 shadow-2xl print:shadow-none print:border-none print:rounded-none print:p-0">
        ...
        <div className="flex justify-between items-start border-b-4 border-primary pb-8 mb-10">
          <div>
            ...
            <p className="text-slate-500 font-semibold uppercase text-xs tracking-[0.3em]">Klinflow PaaS Ecosystem · Quarterly Disclosure</p>
          </div>
        ...
        <div className="mt-16 pt-8 border-t-2 border-slate-100 dark:border-white/5 grid grid-cols-2 gap-10 italic">
           ...
           <div className="text-right flex flex-col items-end">
              ...
              <p className="text-xs font-semibold text-slate-900 dark:text-white not-italic uppercase tracking-widest">Klinflow Logistics Hub</p>
        ...
        <div className="hidden print:block mt-12 text-center text-xs text-slate-300 uppercase tracking-[0.5em]">
           Klinflow PaaS · Sustainomics Engine · Verified Environmental Data
        </div>
      </div>
