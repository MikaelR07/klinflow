...
import { useThemeStore, useAuthStore, useNotificationStore } from '@cleanflow/core';
...
export default function App() {
  ...
  const isAuthorized = isAuthenticated && (profile?.role === 'admin' || profile?.agent_account_type === 'company_admin');
        ...
        <div className="flex flex-col h-full p-6">
          ...
          <div className="flex items-center justify-between mb-10">
            <div className="flex items-center gap-2">
               ...
               <span className="text-xl font-semibold tracking-tighter">CleanFlow <span className="text-primary">Hub</span></span>
            </div>
