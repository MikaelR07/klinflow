-- Fix get_available_bookings: 
-- 1. Fleet drivers see jobs targeted to their company hub
-- 2. Case-insensitive material matching
-- 3. Fleet drivers inherit weight limits from company admin (not their own stale profile)
