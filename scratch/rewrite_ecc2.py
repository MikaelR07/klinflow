...
const MOCK_LOCATION_RANKING = [
  ...
  { name: 'Langata', value: 3800, max: 10000 },
  { name: 'Roysambu', value: 3100, max: 10000 },
  { name: 'Karen', value: 2500, max: 10000 },
];
          ...
          <div className="grid grid-cols-1 xl:grid-cols-12 gap-3 lg:gap-4">
            ...
            <Card className="xl:col-span-3 flex flex-col">
              ...
              <div className="flex-1 h-[250px] w-full mt-2">
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={MOCK_PAYOUTS} layout="vertical" margin={{ top: 0, right: 0, left: 0, bottom: 0 }}>
                    <CartesianGrid strokeDasharray="3 3" stroke={isDarkMode ? '#1e293b' : '#f1f5f9'} horizontal={false} />
                    <XAxis type="number" hide />
                    <YAxis dataKey="name" type="category" axisLine={false} tickLine={false} tick={{ fontSize: 10, fill: '#94a3b8' }} width={30} />
                    <Tooltip cursor={{ fill: 'transparent' }} content={<CustomTooltip />} />
                    <Bar dataKey="amount" fill="#6366f1" radius={[0, 4, 4, 0]} barSize={15} />
                  </BarChart>
                </ResponsiveContainer>
              </div>
            </Card>
