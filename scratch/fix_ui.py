...
# We need to replace everything from ROW 1 to the MODAL
start_marker = r'\{/\*\s*── ROW 1: KPI CARDS ──\s*\*/\}'
end_marker = r'\{/\*\s*── BROADCAST RFQ MODAL \(DESKTOP FORM COMPLIANT\) ──\s*\*/\}'

ui_replacement = """{/* ── ROW 1: KPI CARDS ── */}
...
# ensure component closes correctly by removing double closing tags if they exist
