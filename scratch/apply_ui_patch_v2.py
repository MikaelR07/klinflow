...
# 2. Add LineChartIcon and TrendingDown to lucide imports
content = content.replace(
    "PieChart as PieChartIcon\n} from 'lucide-react';",
    "PieChart as PieChartIcon,\n  LineChart as LineChartIcon,\n  TrendingDown\n} from 'lucide-react';"
)

# 3. Insert mock data before COLORS
mock_data = """
...
# 4. Find the CORRECT return statement — the one that starts with "  return (\n    <div"
# This is the component return, NOT the useEffect cleanup return
marker = "  return (\n    <div className=\"space-y-6 animate-fade-in pb-10\">"
start_index = content.find(marker)
if start_index == -1:
    print("ERROR: Could not find the return(<div) marker")
    exit(1)

print(f"Found return statement at character index {start_index}")
